...
public class Robo {
	...
	public static void mostrar() {
		System.out.println(Ansi.BLACK + Ansi.BACKGROUND_YELLOW + "X" + Ansi.BACKGROUND_CYAN+"Y1 2 3 4 5");
		//System.out.println("Y|-  -  -  -  -");
		for (int i = 0; i < 5; i++) {
			System.out.print(Ansi.BACKGROUND_YELLOW+Ansi.BLACK +(i+1) + Ansi.BACKGROUND_BLACK + " ");
			for (int j = 0; j < 5; j++) {

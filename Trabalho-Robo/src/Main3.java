...
public class Main3 {
    public static void main(String[] args) {
        ...
        Robo robo2 = new RoboInteligente("B", 1, 2);
        ...
        while (!Robo.encontrouAlimento(robo1) && !Robo.encontrouAlimento(robo2)) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if (robos[i] instanceof RoboInteligente) {
                    if (RoboInteligente.ultimoMovimentoValido) {
                        opcao = direcoes[((RoboInteligente) robos[i]).gerarMovimentoInteligente()];
                    }
                }
                ...
                try {
                    ...
                    if (robos[i] instanceof RoboInteligente) {
                        RoboInteligente.ultimoMovimentoValido = true;
                    }
